export class Upgrade extends Screen
  new: =>
    ...
    @amount = {}
    @amount[1] = {{2, 4, 8, 13, 20, 30}, {25, 50, 80, 115, 155, 200}, {0.2, 0.5, 1.0, 1.5, 2.0, 2.8}, {50, 100, 175, 250, 325, 400}}
    @amount[2] = {{2, 4, 6, 9, 13, 18}, {15, 30, 50, 70, 100, 150}, {0.25, 0.75, 1.25, 2.0, 2.8, 3.65}, {-2.5, -5.0, -7.5, -10.0, -12.5, -15.0}}
